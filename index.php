...
.,;;,;;,:l,....      .'clcl::,,;::c;,,:c:lclllcccloolll,'      .''''',cllllc:..
  ...',::c:::;;...   :lllcc;;,';:;,,,;:;,;,,:;::lolcllol......clccclcc;;,....
     ',;:cc::c:,c' .'loollloooo;;<span class="lock lock-glow">@@@@@@@@@@@@@</span>;llool':;..;oo::cccccc.
     ',;::::ccccl;..'ddolll;:c;<span class="lock lock-glow">@@@@@@@@@@@@@@@@@</span>;llooc... .cd;,,;;;:cc.
     .',,;;:ccc:l:..,ldolo:;,;<span class="lock lock-glow">@@@@@@       @@@@@@</span>;,:odc',. .ld;;;:ccl::..

...
switch ($cmd) {
    ...
    case "help":
        ...
        <a class=\"w\" href=\"https://gchq.github.io/CyberChef/>Cyber Chef</a></br>
        ";
        echo "</br></br>";
        break;
...
//Tier 1
    case "tier1-start":
        ...
        echo "Type the answer as the next command. It might also be helpful to write down commands and answers in case you need to use it again later.";
        echo "</br></br>";
        break;
    ...
    case "45.60.102.54":
        ...
        echo "For the next question use command ~\$t1q2";
        echo "</br></br>";
        break;
    ...
    case "t1q2":
        ...
        echo "Type the answer as the next command.";
        echo "</br></br>";
        break;
    ...
    case "injection":
        ...
        echo "For the next question use command ~\$t1qiii";
        echo "</br></br>";
        break;
...
//Tier 2 Question 1
    case "t2q01":
        ...
        echo "----------------------------------<br>";
        echo "For a hint you can use the command ~\$t2q1hint1";
        echo "</br></br>";
        break;
    ...
    case "t2q1hint1":
        ...
        echo "For another hint you can use the command ~\$t2q1hint2";
        echo "</br></br>";
        break;
    ...
    case "t2q1hint2":
        ...
        echo "Gur svefg bar vf nyjnlf rnfl.</br>Gur pbzznaq sbe gur arkg punyyratr vf ~\$g2dav</br></br>";
        echo "----------------------------------<br>";
        echo "HINT 1: Find the name of the person who first uttered the title of this challenge. His name is the type of cipher used here.</br></br>";
        ...
        echo "For another hint you can use the command ~\$t2q1hint3";
        echo "</br></br>";
        break;
...
//Tier 2 Question 2
    ...
    case "t2qni":
        ...
        echo "----------------------------------<br>";
        echo "For a hint you can use the command ~\$t2qnihint1";
        echo "</br></br>";
        break;
    ...
    case "t2qnihint1":
        ...
        echo "For another hint you can use the command ~\$t2qnihint2";
        echo "</br></br>";
        break;
    ...
    case "t2qnihint2":
        ...
        echo "For another hint you can use the command ~\$t2qnihint3";
        echo "</br></br>";
        break;
...
//Tier 2 Question 3
    ...
    case "t2qdrei":
        ...
        echo "----------------------------------<br>";
        echo "For a hint you can use the command ~\$t2qdreihint1";
        echo "</br></br>";
        break;
    ...
    case "t2qdreihint1":
        ...
        echo "For another hint you can use the command ~\$t2qdreihint2";
        echo "</br></br>";
        break;
    ...
    case "t2qdreihint2":
        ...
        echo "For another hint you can use the command ~\$t2qdreihint3";
        echo "</br></br>";
        break;
    ...
    case "t2qdreihint3":
        ...
        echo "----------------------------------<br>";
        echo "HINT 1: Just like before, this challenge requires multiple steps. There's more variety in the types of operations performed now, too.</br></br>";
        echo "HINT 2: It's dangerous to go alone. Take <a target=\"_blank\" class=\"w\" href=\"https://simple.wikipedia.org/wiki/Computer_numbering_formats\">this</a>. Various number formats can be converted to text easily online, but which formats are being used here?</br></br>";
...
//Tier 3
    ...
    case startsWith($cmd, "cd"):
        echo "$cmd";
        echo "</br></br>";
        echo "You're stuck here. Finde another way.";
        echo "</br></br>";
        break;
    ...
    case "research":
        echo "$cmd";
        echo "</br></br>";
        echo "Your humble host for this capture the flag event.<br>If asked nicely they may offer a hint or a cookie.";
        echo "</br></br>";
        break;
    ...
    case startsWith($cmd, "who"):
        ...
        if ($_COOKIE["user"] === "root"){
            ...
            echo $_COOKIE["user"];
            echo "</br>";
            echo "<span style=\"font-weight:bold;\" class=\"key lock-glow\">slctf[a1JteF]</span>";
            echo "</br></br>";
        }
        elseif ($_COOKIE["user"] === "research"){
            ...
            echo "Cookies are the answer to life the universe and everything";
            echo "</br></br>";
        }
        elseif ($_COOKIE["user"] === "42"){
            ...
            echo "<span style=\"font-weight:bold;\" class=\"key lock-glow\">slctf[1Eaz0=]</span>";
            echo "</br></br>";
        }
        else {
            echo "</br></br>";
